C:\Users\Cleber\Downloads\FlowVisionAI-Windows(8)>FlowVisionAI.exe
Traceback (most recent call last):
  ...
  File "torch\multiprocessing\__init__.py", line 21, in <module>
    import platform
    ^^^^^^^^^^^^
  File "<frozen importlib._bootstrap>", line 1176, in _find_and_load
  File "<frozen importlib._bootstrap>", line 1147, in _find_and_load_unlocked
...
[PYI-3880:ERROR] Failed to execute script 'pyi_rth_multiprocessing' due to unhandled exception!

C:\Users\Cleber\Downloads\FlowVisionAI-Windows(8)>